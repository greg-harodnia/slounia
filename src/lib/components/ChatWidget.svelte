<script lang="ts">
	...
	const GREETING: ChatMsg = {
		role: 'assistant',
		text: 'Чалом б’ю! Я бязглузды й недарэчны AI-памочнік. Я ўжываю калькаваную лексыку ў сваіх адказах, таму ня стаўцеся да мяне, як да прадстаўніка Слоўні. Таксама я маю абмежаваньні ў часьціні адказаў, таму я тут толькі для прыгожасьці. Але я маю доступ да зьмесьціва гэтага сайта. Чым магу дапамагчы? 🧐',
	};
