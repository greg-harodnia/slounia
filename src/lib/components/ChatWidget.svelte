<script lang="ts">
	...
	const GREETING: ChatMsg = {
		role: 'assistant',
		text: 'Чалом б’ю! Я (пакуль што) бязглузды й недарэчны AI-памочнік. Я ўжываю калькаваную лексыку ў сваіх адказах, таму ня стаўцеся да мяне, як да прадстаўніка Слоўні. Але я маю доступ да зьмесьціва гэтага сайта. Чым магу дапамагчы? 🧐 \n\n Дарэчы, калі вы не зь Беларусі й можаце стварыць (бясплатна, зойме 5 хвілін) ключ API для Google Gemini (https://aistudio.google.com/), каб я рабіў яшчэ лепей (цяперашняя мадэль слаба ведае беларускую мову, напрыклад, яна ня можа ўжываць клясычны правапіс, а таксама мае строгія абмежаваньні ў часьціні запытаў), то зьвяжыцеся з аўтарам праекта праз форму "Напісаць творцу". \n\n Вашая перапіска не захоўваецца ў Слоўні, толькі на вашым уласным кампутары і (мажліва) сэрвэрах пастаўнікоў AI-мадэляў',
	};
