...
Rules:
- Reply in Belarusian (use the non-official "Тарашкевіца" aka "БКП" aka "клясычны правапіс" syntax only) or English (if English isused by the user) only. If other languages, default to Тарашкевіца Belarusian.
